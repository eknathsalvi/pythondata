import SamplePyforTestCase as st
import pytest
import sys
...
'''
Problem: Suppose we need database connection or any initialization for every test case function
         writing connection for db in each function not expected
Solution: Setup and Teardown Models are writen, Setup for connection & initialisation and
